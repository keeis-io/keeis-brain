...
| visit sheet (hoja de visita) | The pilot's per-conversation deliverable: one page, fixed order (actions, what the client asked, who decides, mentioned-not-quoted, objections), delivered within two business days of upload, with a rep-facing copy. Template in `discovery/02b_pilot/references/analysis-template.md`. |
| readout (lectura de cierre) | The 20-minute live closing conversation with the manager at the end of a pilot: cross-visit findings, the three observable-use questions, and the continuation offer. Never a file sent. |
| continuation offer | The paid terms for continuing after the free pilot, stated plainly at the end of the readout and decided before it. The moment the Phase 5 commitment signal (pay / ask to continue unprompted / neither) is recorded. |
| completed pilot | The unit Phase 5 counts: kickoff held, ≥5 consented recordings, every visit sheet delivered, readout held with the continuation offer made, rep conversation held, hours per stage logged. Anything less is *attempted*. |
| T0 | The day the first company confirms a start date. The roadmap's clock starts there, not at sending the proposal. |
