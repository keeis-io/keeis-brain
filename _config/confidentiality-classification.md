...
|---|---|---|
| Public | Safe for anyone, published on purpose | Nothing yet — pre-launch. A Docmost page or Jira issue only becomes public once it's actually shared outside Keeis. |
...
a handling instruction for humans (who you share it with, whether it goes in a payload to
Docmost/Jira) not a storage rule. Restricted material never gets a tier tag because it never
gets stored here in the first place.
