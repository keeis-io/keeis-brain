...
- Read or listen to Savoia's book, *The Right It* — source: same — status: open; also waiting on
  Erik to confirm the exact title.
...
- Return to Erik with a business plan for a proper review session — source: same — status: open,
  blocked on the `business-plan/` pipeline.
